...
export const register = asyncHandler(async (req, res) => {
  ...
  const user = await User.create({ firstName, lastName, email, phone, password, role, university, studentId });
  ...
  const safeUser = { id:user._id, firstName:user.firstName, lastName:user.lastName, email:user.email, phone:user.phone, role:user.role, university:user.university, studentId:user.studentId };
...
export const me = asyncHandler(async (req, res) => {
  ...
  const safeUser = { id:req.user._id, firstName:req.user.firstName, lastName:req.user.lastName, email:req.user.email, phone:req.user.phone, role:req.user.role, university:req.user.university, studentId:req.user.studentId, twoFAEnabled:req.user.twoFAEnabled };
